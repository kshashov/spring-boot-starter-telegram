...
public class RequestDispatcher {
    ...
    public RequestDispatcher(@NotNull HandlerMethodContainer handlerMethodContainer, @NotNull SessionResolver sessionResolver, @NotNull BotHandlerMethodArgumentResolver argumentResolver, @NotNull BotHandlerMethodReturnValueHandler returnValueHandler) {
    ...
    public BaseRequest execute(@NotNull TelegramEvent event) throws IllegalStateException {
        SessionResolver.SessionHolder sessionHolder = null;
        ...
        try {
            ...
            if (sessionHolder != null) sessionHolder.releaseSession();
        }
    }
